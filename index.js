...
console.log(`Bio of the third artist: "${artists[2]['bio']}".`);

/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
(no function needed) 
There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */

// !!!! Have to comment this task out so the last task can match the index.test.js !!!!
//artists[8]['name'] = "Vincent Van Gogh";
//console.log(`Task2: ${artists[10]['name']}.`);
...
function get20s(array){
  ...
  for (let i=0; i<array.length; i++){
    //isolate birth and death years into variables and check for validity
    let birth = artists[i]['years'].split(" ")[0];
    let death = artists[i]['years'].split(" ")[2];
    if(birth >= 1900 && death < 2000){
      twentyCent.push(artists[i]['name']);
    }
  }
  return twentyCent; //this is how we do
}
...
function addArtist(array){
    array.push({ 
      ...
      genre: "Web Design", 
      nationality: "French",
      bio: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc pretium elementum leo. Etiam dignissim ultrices est, quis pulvinar massa sodales a."
    });
    return array;
  }
...
function randomize(data){
  ...
  for(let i=0; i<newData.length; i++){
    ...
    result.push(newData[randomIndex]);
